...
* **Suporte Multi-Modelo:** Inclui **[BirdNET v2.4](https://huggingface.co/justinchuby/BirdNET-onnx)** (TFLite) e **[Google Perch v2.0](https://huggingface.co/justinchuby/Perch-onnx)** (ONNX). Modelos personalizados podem ser adicionados via configuração JSON ou pela interface.
...
1. **Clone e instale as dependências:**
   ...
   npm install
   ```
   Isso sincroniza automaticamente os binários do ONNX Runtime e empacota o worker LiteRT Wasm via script `postinstall`.
